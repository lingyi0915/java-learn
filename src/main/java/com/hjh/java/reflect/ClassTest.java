...
/** @Author: hjh @Create: 2019/4/18 @Description: */
public class ClassTest {
  ...
  public void classPropertiesDemo() {
    ...
    /** newInstance 根据class获得实例，无法反射数组 泛型对象只能反射类型擦除后的对象指针 */
    ...
    /**
     * getTypeParameters 获得泛型对象的泛型名称，无法获得泛型的具体类型 补充一种可以获得泛型具体实例的办法
     *
    ...
    /**
     * getGenericSuperclass 获得父类的类型 补充一种可以获得泛型具体实例的办法
     *
     * @see GenericSuperclassTest
     */
    ...
    /** getInterfaces 获得class 实现的interface的class */
    System.out.println("------- getInterfaces -----------");
    printArray(
        carr.getInterfaces()); // interface java.lang.Cloneable,interface java.io.Serializable
    printArray(
        cmap
            .getInterfaces()); // interface java.util.Map,interface java.lang.Cloneable,interface
                               // java.io.Serializable,
    printArray(
        cstr
            .getInterfaces()); // interface java.io.Serializable,interface
                               // java.lang.Comparable,interface java.lang.CharSequence,

    /** getGenericInterfaces 获得class 实现的interface的Type */
    System.out.println("------- getGenericInterfaces -----------");
    printArray(
        carr
            .getGenericInterfaces()); // interface java.lang.Cloneable,interface
                                      // java.io.Serializable,
    printArray(
        cmap
            .getGenericInterfaces()); // java.util.Map<K, V>,interface java.lang.Cloneable,interface
                                      // java.io.Serializable,
    printArray(
        cstr
            .getGenericInterfaces()); // interface
                                      // java.io.Serializable,java.lang.Comparable<java.lang.String>,interface java.lang.CharSequence,

    /** getModifiers 获得一个描述修饰符的int值，利用modifier类去解析该int值，得到该class满足哪些修饰符 */
  ...
  public void classNameMethodDemo() {
    ...
    /** toString()方法 分为 class 和 interface 两种开头 */
    ...
    /** getComponentType 获得组成类型 针对数组而言 非数组为null 数组为基本类型 */
    ...
    /** getTypeName 获得TypeName 如果是数组 getComponentType加上[]， 否则 getName() */
    ...
    /** getCanonicalName 返回基础类的规范名称 如果没有则返回null */
